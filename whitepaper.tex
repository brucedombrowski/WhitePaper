...
\toprule
\textbf{Agent} & \textbf{Model} & \textbf{Phase} & \textbf{Key Capability} \\
\midrule
project-setup & Sonnet & Setup & Repo structure, build config, templates \\
requirements & Opus & Phase 1 & Standard interpretation, JSON requirements \\
implementation & Sonnet & Phase 2 & Compliant code within REQ constraints \\
documentation & Sonnet & Phase 3 & DMs, VERs, LaTeX artifacts \\
review & Opus & Phase 4 & Audit with no write access (read-only) \\
\bottomrule
\end{tabularx}
\end{table}
